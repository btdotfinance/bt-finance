...
contract StrategyWBTCUNIFarm  {
    ...
    address constant public want = address(0xBb2b8038a1640196FbE3e38816F3e67Cba72D940);  //ETH/token

    address constant public token = address(0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599);
    address constant public Harvest = address(0xF8ce90c2710713552fb564869694B2505Bfc0846);
	address constant public fUNI = address(0x01112a60f427205dcA6E229425306923c3Cc2073);
	address constant public pool = address(0xF1181A71CC331958AE2cA2aAD0784Acfc436CB93);
