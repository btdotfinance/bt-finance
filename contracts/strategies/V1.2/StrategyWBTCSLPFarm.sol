...
contract StrategyWBTCSLPFarm  {
    ...
    address constant public want = address(0xCEfF51756c56CeFFCA006cD410B03FFC46dd3a58);  //ETH_WBTC SLP

    address constant public Harvest = address(0xF8ce90c2710713552fb564869694B2505Bfc0846);
	address constant public fSLP = address(0x5C0A3F55AAC52AA320Ff5F280E77517cbAF85524);
	address constant public pool = address(0xE2D9FAe95f1e68afca7907dFb36143781f917194);
    ...
    address constant public pair = address(0xCEfF51756c56CeFFCA006cD410B03FFC46dd3a58); //ETH_WBTC SLP
    address constant public swap = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
	...
	function balanceOfFSLP() public view returns (uint256) {
	    uint256 _fslp = IERC20(fSLP).balanceOf(address(this));
		return _fslp.add(IERC20(pool).balanceOf(address(this)));
	}
